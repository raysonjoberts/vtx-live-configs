...
COMMANDS = [
    #os.path.join(BTDM_ROOT, "usr", "scripts", "default", "intake_processor.py"),
    os.path.join(BTDM_ROOT, "usr", "scripts", "default", "config_tables_to_conf.py"),
    os.path.join(BTDM_ROOT, "usr", "scripts", "default", "table_aggregator.py"),
    os.path.join(BTDM_ROOT, "usr", "scripts", "default", "aggregations_table_to_conf.py"),
    os.path.join(BTDM_ROOT, "usr", "scripts", "default", "pivot_processor.py"),
    os.path.join(BTDM_ROOT, "usr", "scripts", "default", "program_attribute_reporting.py"),
    os.path.join(BTDM_ROOT, "usr", "scripts", "default", "program_task_processor.py"),
    os.path.join(BTDM_ROOT, "usr", "scripts", "default", "datasource_type_profiler.py"),
    os.path.join(BTDM_ROOT, "usr", "scripts", "default", "data_source_analysis.py"),
    os.path.join(BTDM_ROOT, "usr", "scripts", "default", "program_attribute_reporting.py"),
]
# --------------------------------
